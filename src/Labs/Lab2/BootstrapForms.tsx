import { FormGroup, FormLabel, FormControl, FormSelect, Form, Col, InputGroup, Row, Button } from "react-bootstrap";
...
export function BootstrapForms2() {
    return (
...
export function BootstrapForms3() {
    return (
...
export function BootstrapForms4() {
    return (
...
export function BootstrapForms5() {
    return (
...
export function BootstrapForms6() {
    return (
...
export function BootstrapForms7() {
    return (
