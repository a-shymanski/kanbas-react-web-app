    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Boil two cups of water.</li>
          <li>Add the ramen noodles.</li>
          <li>Stir the ramen for 2-3 minutes.</li>
          <li>Strain the water.</li>
          <li>Add and mix the seasoning.</li>
...
Please
<a href="https://github.com/a-shymanski/kanbas-react-web-app" id="wd-github">click here</a>
