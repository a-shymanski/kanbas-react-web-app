...
export default function Modules() {
  ...
  return (
    <div className="wd-modules">
      ...
      <div><ModulesControls setModuleName={setModuleName} moduleName={moduleName} addModule={createModuleForCourse} />
      </div> }
      <br /><br /><br />
          ...
          .map((module: any) => (
            <li className="wd-module list-group-item p-0 mb-5 fs-5 border-gray" key={module._id}>
              <div className="wd-title p-3 ps-2 bg-secondary">
                ...
                { currentUser && currentUser.role === "FACULTY" && module.editing && (
                ...
                <ul className="wd-lessons list-group rounded-0">
                  {module.lessons.map((lesson: any) => (
                    <li className="wd-lesson list-group-item p-3 ps-1" key={lesson._id}>
                      <BsGripVertical className="me-2 fs-3" /> {lesson.name} { currentUser && currentUser.role === "FACULTY" && <LessonControlButtons /> }
                    </li>
                  ))}
                </ul>
              )}
