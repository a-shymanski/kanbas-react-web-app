...
export default function ModulesControls(
    ...
    return (
        <div id="wd-modules-controls" className="text-nowrap">
            ...
            <Dropdown className="float-end me-2">
                <Dropdown.Toggle variant="secondary" size="lg" id="wd-collapse-all">
                    Collapse All
                </Dropdown.Toggle>
                <Dropdown.Menu>
                    ...
                    <Dropdown.Item id="wd-collapse-all-modules-and-items">
                        Collapse all modules and items
                    </Dropdown.Item>
                    <Dropdown.Item id="wd-collapse-modules-only">
                        Collapse modules only
                    </Dropdown.Item>
                    <Dropdown.Item id="wd-uncollapse-all-modules-and-items">
                        Uncollapse all modules and items
                    </Dropdown.Item>
                    <Dropdown.Item id="wd-uncollapse-modules-only">
                        Uncollapse modules only
                    </Dropdown.Item>
                </Dropdown.Menu>
            </Dropdown>
